...
void FluidDraw(FluidCube * cube, GLProgram& gl) {
    //draw_velocity(cube, gl);
    draw_density(cube, gl);
}

void draw_velocity(FluidCube * cube, GLProgram& gl)
{
    int i, j, k;
    float x, y, z, h;
    int N = cube->size;
    ...
    //glBegin ( GL_LINES );
    const Vector3f PENDULUM_COLOR(1.0f, 1.0f, 1.0f);
